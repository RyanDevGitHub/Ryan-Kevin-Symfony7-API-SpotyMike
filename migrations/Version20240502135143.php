 ...
 */
final class Version20240502135143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artist (id INT AUTO_INCREMENT NOT NULL, user_id_user_id INT NOT NULL, fullname VARCHAR(90) NOT NULL, label VARCHAR(90) NOT NULL, description LONGTEXT DEFAULT NULL, date_begin DATETIME NOT NULL, date_end DATETIME DEFAULT NULL, active INT DEFAULT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_1599687DE94BC09 (user_id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
